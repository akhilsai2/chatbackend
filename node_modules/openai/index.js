...
class OpenAI extends Core.APIClient {
   ...
   * API Client for interfacing with the OpenAI API.
   *
   * @param {string} [opts.apiKey=process.env['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']] - The API Key to send to the API.
  ...
  constructor(_b) {
    var _c, _d;
    var {
      apiKey = Core.readEnv('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'),
      organization = (_c = Core.readEnv('org-WCdSqD7lU0BLmUNEsw7rcYb9')) !== null && _c !== void 0 ? _c : null,
      ...opts
    } = _b === void 0 ? {} : _b;
    if (apiKey === undefined) {
      throw new Error(
